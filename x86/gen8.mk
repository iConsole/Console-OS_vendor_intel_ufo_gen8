...
UFO_HEADERS := $(shell find $(LOCAL_PATH)/$(TARGET_ARCH)/ -maxdepth 1 -not -type d -name "*.h")
UFO_HEADERS := $(patsubst $(LOCAL_PATH)/%, %, $(UFO_HEADERS))
...
LOCAL_REQUIRED_MODULES += libva-tpi
include $(BUILD_PHONY_PACKAGE)

include $(CLEAR_VARS)
LOCAL_COPY_HEADERS_TO := ufo
LOCAL_COPY_HEADERS := $(UFO_HEADERS)

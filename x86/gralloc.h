...
enum {
    ...
    INTEL_UFO_GRALLOC_MODULE_PERFORM_SET_BO_COMPR_HINT     = 24,   // (buffer_handle_t, uint32_t hint)
    INTEL_UFO_GRALLOC_MODULE_PERFORM_GET_BO_COMPR_HINT     = 25,   // (buffer_handle_t, uint32_t *hint)
    INTEL_UFO_GRALLOC_MODULE_PERFORM_SET_RESOLVE_DETAILS   = 26,   // (buffer_handle_t, const intel_ufo_buffer_resolve_details_t*)
    INTEL_UFO_GRALLOC_MODULE_PERFORM_GET_RESOLVE_DETAILS   = 27,   // (buffer_handle_t, intel_ufo_buffer_resolve_details_t*)
    INTEL_UFO_GRALLOC_MODULE_PERFORM_SET_CAMERA_DETAILS    = 28,   // (buffer_handle_t, const intel_ufo_buffer_camera_details_t *details)
    INTEL_UFO_GRALLOC_MODULE_PERFORM_GET_CAMERA_DETAILS    = 29,   // (buffer_handle_t, intel_ufo_buffer_camera_details_t *details)
...
enum {
    ...
    INTEL_UFO_BUFFER_HINT_RC_FULL_RESOLVE       = 0u,
    INTEL_UFO_BUFFER_HINT_RC_PARTIAL_RESOLVE    = 1u,
    INTEL_UFO_BUFFER_HINT_RC_DISABLE_RESOLVE    = 2u,
...
typedef struct intel_ufo_buffer_resolve_details_t
{
    ...
    struct {
        ...
        union {
            struct {
                struct {
                    union { uint32_t red;   float redf; };
                    union { uint32_t green; float greenf; };
                    union { uint32_t blue;  float bluef; };
                    union { uint32_t alpha; float alphaf; };
                } color;
            } fast_clear;
        } data;
    } resource;
